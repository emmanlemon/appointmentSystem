    ...
    <div class="container-fluid h-custom">
      <div class="row d-flex justify-content-center align-items-center h-100">
        ...
        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1 bg-white p-5 rounded shadow">
          <form action="{{ route('auth.resetPassword') }}" method="post" enctype="multipart/form">
            @csrf
            ...
            <label class="form-label">Password</label>
              <input type="password" name="password" class="form-control form-control-lg"
                placeholder="Enter the Password" value="{{ old('password') }}" required/>
            </div>

            <div class="form-outline mb-2">
                <label class="form-label">Confirm Password</label>
                  <input type="password" name="confirm_password" class="form-control form-control-lg"
                    placeholder="Enter the Confirm Password" value="{{ old('confirm_password') }}" required/>
                </div>
